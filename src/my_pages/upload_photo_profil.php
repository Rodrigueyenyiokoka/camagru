...
require_once '../class/session_start.php';
    ...
    {
         if (!is_dir('../../My_gallery_photo'))
         {
            mkdir('../../My_gallery_photo');
            if (!is_dir('../../My_gallery_photo/'.$login))
            mkdir('../../My_gallery_photo/'.$login);
         }
        ...
        if ($_POST['type'] == 'png')
            $filename = '../../My_gallery_photo/'.$login.'/'.$name_img.'.png';
        else
            $filename = '../../My_gallery_photo/'.$login.'/'.$name_img.'.jpeg';
