...
$title = 'Settings';
$js_source = ['../js/comment_notif.js', '../js/settings.js'];
session_start();
        ...
        <div class="container">
            <div class="row divform">
                ...
                <i class="fa fa-cog fa-spin" style="font-size:48px;color:red"></i>
                    <p class="center"style="color:green"><i class="fa fa-user-circle settings"style= "color:green"></i>Personal information</p>
                    <p class="center"style="color:green">Manage information about you and your account in general.</p>
                        <form method="POST"  id="registerform" >
                            <input type="text"style= "color:red" name="username" value="" placeholder="New username">
                            ...
                            <button class="settings submit btn"type="submit" name="submit" value="OK"><b>Save</b></button>
                            <button class="settings reset btn" type="reset" name="reset" value="Reset"><b>Cancel</b></button>
                            
                        </form>
                    </div>
                <div class="user_prefeferences col-md-6">
                    <p class="center"style= "color:green"><i class="fa fa-calendar-check settings"style= "color:green"></i><b>Add or change your preferences</b></p>
                    <p class="center"style= "color:green">Manage your preferences.</p>
                    <div class="row notif_row">
                     ...
                     <div class="row notif_row"style= "color:green">
                        Theme
                        <select id="selectTheme" onchange="change_theme(this.id)" name="test">
                            <option value="1" id="defaultTheme"  <?php if ($theme == 'Default') echo "selected";?>style=>Default</option>
                            <option value="2" id="greenTheme" <?php if ($theme == 'Green') echo "selected";?>>Green</option>
                            <option value="3" id="blueTheme" <?php if ($theme == 'Blue') echo "selected";?>>white</option>
                        </select>
                     </div>
                </div>
            </div>
