...
$js_source = ['../js/funct_like.js', '../js/funct_comments.js', '../js/delete_image.js'];
$title = 'my_Gallery';
...
<div class="row">
  <div class="container-card" id="<?php echo $image_id?>">
    ...
    {
      if ($i == $currentpage)
        echo '<a class="active" href="user_my_gallery.php?page='.$i.'">'.$i.'</a>';
      else
        echo '<a href="user_my_gallery.php?page='.$i.'">'.$i.'</a>';
