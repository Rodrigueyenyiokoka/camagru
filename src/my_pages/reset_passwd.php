            ...
            foreach ($result as $row)
            {
                ...
                <div class='row'>
                    <div class='container'>
                        ...
                        <a href='http://localhost:8080/camagru/src/my_pages/password_conf.php?log=".urlencode($login)."&cle=".urlencode($user_reset_passwd_code)."'>
                        <button type='button' style='color:white;background-color:#1cff9f;padding:10px;cursor:pointer;border-radius:5px;'>Reset Password</button></a>
                        <hr>
