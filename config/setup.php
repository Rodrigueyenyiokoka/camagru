...
require_once 'database.php';
    ...
    try {
        ...
        $conn->exec($sql);
        echo "Users Table deleted successfully<br><br>";
        ...
        $conn->exec($sql);
        echo "Users Table is created successfully<br><br>";
        $sql =  "DROP TABLE IF EXISTS gallery";
        $conn->exec($sql);
        echo " Gallery's table deleted successfully<br><br>";
        ...
        $conn->exec($sql);
        echo " Gallery Table created successfully<br><br>";
        $sql =  "DROP TABLE IF EXISTS comments";
        $conn->exec($sql);
        echo " Comments table deleted successfully<br><br>";
        ...
        $conn->exec($sql);
        echo " Comments Table created successfully<br><br>";
        $conn = null;
        }
